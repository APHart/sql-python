...
def get_project_by_title(title):
    ...
    QUERY = """
        SELECT title, description, max_grade FROM projects WHERE title = :title
        """
...
def get_grade_by_github_title(github, title):
    ...
    QUERY = """ SELECT student_github, grade, project_title
                FROM grades
    ...
    print "{} recieved {} for {}.".format(row[0], row[1], row[2])
...
def assign_grade(github, title, grade):
    ...
    QUERY = """
            INSERT INTO grades (student_github, grade, project_title)
    ...
    print "Grade of {} for {} on {} project Successfully added.".format(grade,
          github, title)
...
def handle_input():
    ...
    while command != "quit":
        ...
        if command == "student":
            ...
            title = args[0]  #if want to keep format --> title, = args
